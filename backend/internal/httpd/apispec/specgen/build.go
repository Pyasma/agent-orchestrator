...
var schemaNames = map[string]string{
	...
	"ControllersDetectedPort":                             "DetectedPort",
	"ControllersPreviewDetectedPortsResponse":             "PreviewDetectedPortsResponse",
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/preview/ports", id: "getSessionPreviewDetectedPorts", tag: "sessions",
			summary:    "List listening ports detected among the descendants of a session's runtime process",
			pathParams: []any{controllers.SessionIDParam{}},
			resps: []respUnit{
				{http.StatusOK, controllers.PreviewDetectedPortsResponse{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
			},
