...
func shellTerminalOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPatch, path: "/api/v1/settings/auto-pause", id: "updateAutoPause", tag: "settings",
			summary: "Set how long an agent may sit idle before AO pauses it (zero turns it off)",
			reqBody: controllers.UpdateAutoPauseRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.SettingsResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/pause-idle", id: "pauseIdleSessions", tag: "sessions",
			summary:    "Pause every idle worker agent, keeping its session for resume",
			pathParams: []any{controllers.PauseIdleSessionsQuery{}},
			resps: []respUnit{
				{http.StatusOK, controllers.PauseIdleSessionsResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
