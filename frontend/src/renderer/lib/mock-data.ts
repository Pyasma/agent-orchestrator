				...
				conflictFiles: [
					{
						...
						url: "https://github.com/me/webgl-preview/pull/51/files#diff-src-render-texture-cache-ts",
					},
					{
						path: "src/render/webgl-context.ts",
						url: "https://github.com/me/webgl-preview/pull/51/files#diff-src-render-webgl-context-ts",
					},
				],
			},
		}),
